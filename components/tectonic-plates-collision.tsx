...
const TectonicPlatesCollision = () => {
  ...
  return (
    <div className="w-full max-w-3xl mx-auto p-4">
      <h2 className="text-2xl font-bold mb-4 text-center">Himalayan Formation: Plate Collision and Subduction</h2>
      <div className="relative aspect-video bg-gradient-to-b from-sky-200 to-orange-100 overflow-hidden rounded-lg shadow-lg">
        ...
        >
          ...
          {/* Subduction Zone */}
          <path className="subduction-zone" d="M500 350 Q400 450 300 600" fill="none" stroke="#FF5722" strokeWidth="3" strokeDasharray="5,5" />
          ...
          {/* Himalaya Label Arrow */}
          <g className="himalaya-label">
            <path d="M600 100 L520 200" fill="none" stroke="#4A148C" strokeWidth="2" markerEnd="url(#arrowhead)" />
            <text x="610" y="95" fontSize="20" fill="#4A148C">Himalayas</text>
          </g>
      ...
      <p className="mt-4 text-center text-sm text-gray-600">
        This animation shows the Indian Plate colliding with and subducting under the Eurasian Plate, 
        leading to the formation and uplift of the Himalayas. This process occurs over millions of years.
      </p>
    </div>
  )
}
